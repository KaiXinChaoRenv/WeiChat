      ...
      try {
        ...
        wx.login({
          success(res) {
            ...
            if (res.code) {
              wx.request({
                url: `httpss://wx.request.huangjinyu.xyz:8100/wx_login/login`,
                data: {
