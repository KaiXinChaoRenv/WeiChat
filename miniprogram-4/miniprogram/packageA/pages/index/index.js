...
let colors = ["rgba(208,217,232,0.5)", "rgba(224,209,214,0.5)", "rgba(148,182,194,0.5)", "rgba(58,67,98,0.5)", "rgba(146,177,208,0.5)", "rgba(65,111,152,0.5)", "transparent"];
// let colors = ["rgba(36,123,160,0.5)", "rgba(112,193,179,0.5)", "rgba(178,219,191,0.5)", "rgba(243,255,189,0.5)", "rgba(255,22,84,0.5)", "rgba(65,111,152,0.5)", "transparent"];
